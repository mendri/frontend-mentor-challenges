function App() {
  ...
  return (
    <div className="h-full not-mobile:flex">
      <header className="flex flex-col items-center w-full rounded-b-3xl bg-gradient-to-t from-light-royal-blue to-light-slate-blue not-mobile:w-1/2 not-mobile:justify-evenly not-mobile:rounded-3xl">
        ...
        <div className="mt-4 w-28 h-28 rounded-full flex flex-col items-center justify-center bg-gradient-to-b from-violet-blue to-persian-blue not-mobile:w-60 not-mobile:h-60 not-mobile:m-0">
        ...
        <p className="mt-4 font-HankenGrotesk font-bold text-xl text-white not-mobile:m-0 not-mobile:text-4xl">Great</p>
        <div className="flex justify-center w-4/6 text-center not-mobile:w-2/6">
          <p className="text-xs opacity-50 font-bold text-white mt-2 mb-10 not-mobile:mb-0 not-mobile:-m-10 not-mobile:text-xl">You scored higher than 65% of the people who have taken these tests.</p>
        </div>
      </header>
      <main className="flex flex-col items-center not-mobile:justify-evenly not-mobile:w-1/2">
        <p className="mt-6 mb-2 ml-6 self-start text-lg font-HankenGrotesk font-bold not-mobile:text-2xl not-mobile:ml-16">Summary</p>
        <div className="w-4/5 mt-4 flex rounded-lg justify-between bg-light-red bg-opacity-30 p-4">
          <div className="flex">
        ...
        <div className="w-4/5 mt-4 flex rounded-lg justify-between bg-orangey-yellow bg-opacity-30 p-4">
          <div className="flex">
        ...
        <div className="w-4/5 mt-4 flex rounded-lg justify-between bg-green-teal bg-opacity-30 p-4">
          <div className="flex">
        ...
        <div className="w-4/5 mt-4 flex rounded-lg justify-between bg-cobalt-blue bg-opacity-30 p-4">
          <div className="flex">
